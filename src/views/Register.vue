    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                formCollapseSeven: {
                    sepaFullname: this.$store.getters.user.firstname ? `${this.$store.getters.user.firstname} ${this.$store.getters.user.lastname}` : null,
                    sepaIBAN: null,
                    sepaConsent: false
                },
                formCollapseEight: {
        ...
        methods: {
            ...
            stepOne() {
                ...
                let object = {
                    ...
                    emailconsent: this.formCollapseOne.emailconsent.toString(),
